  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "yashgargg4@gmail.com",
      href: "mailto:yashgargg4@gmail.com",
      color: "primary",
    },
    {
      icon: Phone,
    ...
    },
    {
      ...
      label: "Code Repository",
      value: "GitHub Profile",
      href: "https://github.com/yashgarg4", // replace with your actual GitHub
      color: "primary",
    },
    {
      icon: Linkedin,
      label: "Professional Network",
      value: "LinkedIn Profile",
      href: "https://linkedin.com/in/yashgarg04", // replace with your LinkedIn
      color: "primary",
    },
  ];
    ...
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Get In Touch</h2>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Connect with me directly through email, phone, or social links.
          </p>
        </div>

        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          <div className="animate-in slide-in-from-bottom-8 duration-1000">
            ...
            <p className="text-xl md:text-2xl mb-8 font-light">
              <strong>Versatile Software Engineer</strong>
            </p>
            <p className="text-lg mb-12 max-w-2xl mx-auto opacity-90">
              Building cross-platform applications, intelligent automation
              tools, and agentic AI systems. Proven track record in developing
              scalable tools, integrating SDKs, and solving real-world problems
              with impact.
            </p>

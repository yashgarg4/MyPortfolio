...
export function AiChatSection() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      type: "ai",
      content:
        "Hi! I'm Yash's AI assistant. I can answer questions about his experience, skills, projects, and background. What would you like to know?",
      timestamp: new Date(),
    },
  ]);
  ...
  const suggestedQuestions = [
    "What's your experience with AI space?",
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Chat with my AI assistant to learn more about my background,
              projects, and skills
            </p>
          </div>
